...
class Alipay::ClientTest < Minitest::Test
  ...
  def test_sdk_execute_for_alipay_trade_app_pay
    ...
    assert_equal string, @client.sdk_execute(method: 'alipay.trade.page.pay', biz_content: { out_trade_no: '20160401000000', product_code: 'QUICK_MSECURITY_PAY', total_amount: '0.01', subject: 'test' }.to_json, timestamp: '2016-04-01 00:00:00')
  end
  ...
  def test_page_execute_url_for_alipay_trade_page_pay
    ...
    assert_equal url, @client.page_execute_url(method: 'alipay.trade.page.pay', biz_content: { out_trade_no: '20160401000000', product_code: 'FAST_INSTANT_TRADE_PAY', total_amount: '0.01', subject: 'test' }.to_json, timestamp: '2016-04-01 00:00:00')
  end
  ...
  def test_page_execute_form_for_alipay_trade_page_pay
    ...
    assert_equal form, @client.page_execute_form(method: 'alipay.trade.page.pay', biz_content: { out_trade_no: '20160401000000', product_code: 'FAST_INSTANT_TRADE_PAY', total_amount: '0.01', subject: 'test' }.to_json, timestamp: '2016-04-01 00:00:00')
  end
