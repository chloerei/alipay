...
module Alipay
  module Service
    ...
    CREATE_FOREX_SINGLE_REFUND_URL_REQUIRED_OPTIONS = %w( out_return_no out_trade_no return_amount currency gmt_return reason )
    CREATE_FOREX_SINGLE_REFUND_URL_REQUIRED_OPTIONAL_OPTIONS = %w( return_rmb_amount )
    # 支付宝境外收单单笔退款接口
